...
const Root = () => {
  return (
    <div className="overflow-x-hidden relative">
      <div className="flex flex-col  gap-3 bottom-32 right-8 z-50  fixed">
        <a
          className="flex flex-col items-center"
          target="_blank"
          href={`https://www.linkedin.com/company/threatmit-security-and-safety-consultants/?originalSubdomain=ng`}
        >
          {/* <IoLogoLinkedin className=" " size={"50px"} /> */}
          <IoLogoLinkedin className=" " size={"50px"} />
