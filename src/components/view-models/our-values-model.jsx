...
const OurValuesModel = ({ title, details }) => {
  return (
    <div className=" min-h-[200px] bg-gray-100 hover:bg-[#330d70] hover:text-white rounded-md  flex flex-col  py-6 px-4 transform hover:-translate-y-2 transition-all duration-700 ease-in-out group">
